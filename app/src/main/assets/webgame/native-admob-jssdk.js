...
(function () {
    ...
    /**
     * @param {Object} payload 必须含 {@code action}；可选 {@code placement}、{@code position}
    ...
    window.NativeAdmobJSSDK = {
        ...
        /** 通知 Android 拉取 game-config 并销毁、重建所有下层 WebView */
         ...
         * {@code showOpenAd}、{@code showSplashAd}、{@code playOpenAd}、{@code showInterstitialAd}（仅调用第一个存在的）。
         */
