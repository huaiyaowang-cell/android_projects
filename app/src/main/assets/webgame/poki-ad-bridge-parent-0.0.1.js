/**
 * Perfect Landing Plane Pilot — 父页面广告桥接（AdSense / adBreak）
 */
(function () {
  "use strict";

  var gameFrame = document.getElementById("plppGameFrame");
  ...
  function showCommercialBreak() {
    return new Promise(function (resolve) {
      ...
      window.adBreak({
        type: "browse",
        name: "perfect-landing-plane-pilot-commercial",
        beforeAd: function () {},
        afterAd: function () {},
  ...
  function showRewardedBreak() {
    return new Promise(function (resolve) {
      ...
      window.adBreak({
        type: "reward",
        name: "perfect-landing-plane-pilot-reward",
        beforeAd: function () {},
        afterAd: function () {},
