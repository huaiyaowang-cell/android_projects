...
import com.gjp.notificationhelper.AlarmScheduler;
import com.gjp.notificationhelper.NotificationPermissionHelper;
import com.gjp.notificationhelper.ScreenLockWakeHelper;
...
public class UnityPlayerActivity extends AppCompatActivity  implements IUnityPlayerLifecycleEvents {
    ...
    public void CallNotificationPermission() {
        if(!NotificationPermissionHelper.hasNotificationPermission(this)) {
            ...
            ScreenLockWakeHelper.init(this);
            //启动 Alarm 循环定时任务
    ...
    public void onAdSdkInitComplete(AdSdkInitComplete event) {
        ...
        AndroidCallUnityHelper.invokeMethod(UnityConst.UNITY_ANDROID_RESULT, UnityConst.APP_SDKOK, "");
        UnityHelper.getInstance().LoadAD(this);
        ADManager.Companion.getAsInstance().createBanner(this, mUnityPlayer, "banner", new IAdListener() {
            @Override
    ...
    public void removeSplash() {
        Log.d("SDK-AD", "删除SplashView " + Thread.currentThread().getName());
        if (mUnityPlayer != null && img != null) {
            mUnityPlayer.removeView(img);
            img = null; // 可选，避免重复调用
        } else {
            Log.w("SDK-AD", "UnityPlayer or SplashView is null, skip remove.");
        }
    }
